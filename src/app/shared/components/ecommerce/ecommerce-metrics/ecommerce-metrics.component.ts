...
import { Box, BoxesService } from '../../../services/box.service';
...
export class EcommerceMetricsComponent {
  ...
  constructor(private userService: UserService, private orderService: OrderService, private itemService: ItemsService, private boxService: BoxesService){}
