  ...
  navItems: NavItem[] = [
    {
      ...
      name: "Dashboard",
      path: "/dashboard",
      access_role: ['admin', 'store']
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none"><path d="M3 11L12 3L21 11V20C21 20.5523 20.5523 21 20 21H14V15H10V21H4C3.44772 21 3 20.5523 3 20V11Z" fill="currentColor"/><path d="M9 21V14H15V21" stroke="currentColor" stroke-width="1.5"/></svg>`,
      name: "Stores",
      path: "/stores",
      access_role: ['admin']
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M8 2C8.41421 2 8.75 2.33579 8.75 2.75V3.75H15.25V2.75C15.25 2.33579 15.5858 2 16 2C16.4142 2 16.75 2.33579 16.75 2.75V3.75H18.5C19.7426 3.75 20.75 4.75736 20.75 6V9V19C20.75 20.2426 19.7426 21.25 18.5 21.25H5.5C4.25736 21.25 3.25 20.2426 3.25 19V9V6C3.25 4.75736 4.25736 3.75 5.5 3.75H7.25V2.75C7.25 2.33579 7.58579 2 8 2ZM8 5.25H5.5C5.08579 5.25 4.75 5.58579 4.75 6V8.25H19.25V6C19.25 5.58579 18.9142 5.25 18.5 5.25H16H8ZM19.25 9.75H4.75V19C4.75 19.4142 5.08579 19.75 5.5 19.75H18.5C18.9142 19.75 19.25 19.4142 19.25 19V9.75Z" fill="currentColor"></path></svg>`,
      name: "Boxes",
      path: "/boxes",
      access_role: ['admin']
    },
